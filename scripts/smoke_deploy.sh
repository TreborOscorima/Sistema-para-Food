...
check_url "$BASE_URL/dono"          200 "Panel dueño"
check_url "$BASE_URL/mozos"         200 "Mozos"
check_url "$BASE_URL/cocina"        200 "Cocina"
check_url "$BASE_URL/caja"          200 "Caja"
check_url "$BASE_URL/mostrador"     200 "Mostrador"
check_url "$BASE_URL/carta"         200 "Carta"
check_url "$BASE_URL/reportes"      200 "Reportes"
check_url "$BASE_URL/usuarios"      200 "Usuarios"
check_url "$BASE_URL/configuracion" 200 "Configuracion"
check_url "$BASE_URL/inventario"    200 "Inventario"
check_url "$BASE_URL/clientes"      200 "Clientes"
check_url "$BASE_URL/cuentas"       200 "Cuentas Corrientes"
check_url "$BASE_URL/promociones"   200 "Promociones"

info "=== Carta digital (ruta dinámica) ==="
check_url "$BASE_URL/menu/mi-restaurante" 200 "Menu público /menu/slug"
