...
def _pendientes_panel() -> rx.Component:
    return rx.vstack(
        ...
        rx.cond(
            ...
            rx.center(rx.text("Los pedidos que armes aparecen aquí hasta que los cobres.",
                              font_size="12px", color=TEXT_MUTED, text_align="center",
                              line_height="1.4"),
                      padding_y="10px", padding_x="8px"),
...
def _cobrados_panel() -> rx.Component:
    return rx.vstack(
        ...
        rx.cond(
            ...
            rx.center(rx.text("Aquí verás los pedidos que ya cobraste hoy.",
                              font_size="12px", color=TEXT_MUTED, text_align="center",
                              line_height="1.4"),
                      padding_y="10px", padding_x="8px"),
