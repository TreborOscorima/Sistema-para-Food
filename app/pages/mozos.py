...
from app.components.shared import anulacion_modal, app_shell, cumpleanos_banner, loading_placeholder, section_card, surface_card
        ...
        rx.vstack(
            ...
            rx.cond(
                ...
                rx.text(
                    ...
                    font_size="10px",
                    font_weight="600",
                    color=rx.cond(selected, "#FED7AA", "#94A3B8"),
                    no_of_lines=1,
                ),
                rx.fragment(),
            ),
            ...
            rx.cond(
                ...
                rx.hstack(
                    rx.text(
                        ...
                        font_size="13px",
                        font_weight="700",
                        color=rx.cond(selected, "#F59E0B", "#94A3B8"),
                    ),
                    rx.text(
...
def _sector_group(sector: str) -> rx.Component:
    return rx.vstack(
        rx.hstack(
            rx.box(width="3px", height="14px", background="#EA580C", border_radius="2px"),
            rx.text(
                sector,
                font_size="14px",
                font_weight="700",
    ...
    return rx.vstack(
            ...
            rx.vstack(
                rx.hstack(
                    ...
                    rx.text(
                        ...
                        font_size="13px", font_weight="600", color="#A78BFA",
                    ),
        ...
        rx.hstack(
            ...
            rx.hstack(
                ...
                rx.text("Reservada", font_size="10px", color="#A78BFA"),
                spacing="1", align="center",
            ),
        ...
        rx.cond(
            ...
            rx.hstack(
                rx.button(
                    ...
                    background=rx.cond(FoodState.mozos_filtro_sector == "", "#EA580C", "#1E293B"),
                    color=rx.cond(FoodState.mozos_filtro_sector == "", "#FFFFFF", "#94A3B8"),
                    border=rx.cond(FoodState.mozos_filtro_sector == "", "1px solid #EA580C", "1px solid #334155"),
                ...
                rx.foreach(
                    ...
                    lambda s: rx.button(
                        ...
                        background=rx.cond(FoodState.mozos_filtro_sector == s, "#EA580C", "#1E293B"),
                        color=rx.cond(FoodState.mozos_filtro_sector == s, "#FFFFFF", "#94A3B8"),
                        border=rx.cond(FoodState.mozos_filtro_sector == s, "1px solid #EA580C", "1px solid #334155"),
                        border_radius="6px", font_size="12px", font_weight="600",
                        padding_x="10px", padding_y="5px", cursor="pointer",
                        _hover={"border_color": "#EA580C"},
                    ),
    ...
    return rx.cond(
        ...
        rx.box(
            rx.hstack(
                ...
                rx.hstack(
                    rx.box(
                        rx.icon(tag="ban", size=13, color="#94A3B8"),
        ...
        rx.box(
            rx.hstack(
                ...
                rx.box(
                    rx.icon(tag="rotate_ccw", size=14, color="#22C55E"),
                    on_click=FoodState.toggle_producto_disponible(producto.id),
                    width="36px",
                    height="36px",
                    border_radius="8px",
...
def _modal_carrito_item(item: CarritoItem) -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.cond(
            ...
            rx.text(
                "⚙ " + item.modificadores_texto,
                font_size="10px", color="#A78BFA", font_weight="500",
                padding_left="2px",
            ),
            rx.fragment(),
        ),
    ...
    return rx.hstack(
        rx.cond(
            ...
            rx.box(
                rx.cond(
                    ...
                    rx.icon(tag="square", size=14, color="#94A3B8"),
                ),
                cursor="pointer",
                flex_shrink="0",
            ),
        ...
        rx.cond(
            ...
            rx.text(
                ...
                color=rx.cond(item.sel_precuenta, "#22C55E", "#94A3B8"),
                flex_shrink="0",
            ),
            rx.fragment(),
        ),
...
def _transfer_mesa_card(mesa: MesaView) -> rx.Component:
    return rx.box(
        rx.vstack(
            ...
            rx.cond(
                mesa.total_abierto > 0,
                rx.text(mesa.total_abierto_texto, font_size="11px", color="#94A3B8"),
                rx.fragment(),
            ),
        ...
        _hover={"border_color": "#EA580C", "background": "#334155"},
        transition="all 0.15s ease",
        min_width="100px",
    )
        ...
        rx.dialog.content(
            rx.vstack(
                ...
                rx.cond(
                    ...
                    rx.hstack(
                        rx.icon(tag="user", size=13, color="#22C55E", flex_shrink="0"),
                        rx.text(
                    ...
                    rx.hstack(
                        rx.icon(tag="user_plus", size=13, color="#94A3B8", flex_shrink="0"),
                        rx.select(
                                    ...
                                    rx.cond(
                                        ...
                                        rx.hstack(
                                            rx.button(
                                                ...
                                                cursor="pointer",
                                                height="auto",
                                                _hover={"color": "#FFFFFF", "border_color": "#94A3B8"},
                                            ),
                                            rx.button(
