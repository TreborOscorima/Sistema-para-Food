...
def _mesa_card(mesa: MesaView) -> rx.Component:
    ...
    return rx.box(
        rx.vstack(
            rx.hstack(
                rx.text(
                    ...
                    font_size="14px",
                    font_weight="700",
                    color=rx.cond(selected, "#F97316", "#F1F5F9"),
                ),
                rx.spacer(),
                rx.badge(
                    mesa.estado_label,
        ...
        background=rx.cond(selected, "#1A0F05", mesa.card_bg),
        border=rx.cond(selected, "2px solid #F97316", mesa.card_border),
        border_radius="10px",
        padding="12px",
        cursor="pointer",
        on_click=FoodState.seleccionar_mesa(mesa.id),
        _hover={"border": "2px solid rgba(249,115,22,0.50)", "transform": "translateY(-1px)"},
...
def _carrito_item_row(item: CarritoItem) -> rx.Component:
    return rx.hstack(
        rx.vstack(
            rx.text(item.nombre, font_size="13px", font_weight="600", color="#F1F5F9"),
            rx.cond(
                item.nota != "",
                rx.text("Nota: " + item.nota, font_size="11px", color="rgba(255,255,255,0.4)"),
                rx.fragment(),
            ),
            spacing="0",
            align="start",
...
def _carrito_section() -> rx.Component:
    return rx.vstack(
        rx.hstack(
            ...
            rx.spacer(),
            rx.text(FoodState.total_carrito_texto, font_size="13px", font_weight="700", color="#F1F5F9"),
            width="100%",
            align="center",
        ),
        rx.cond(
            ...
            rx.center(
                rx.text("Carrito vacio", font_size="12px", color="rgba(255,255,255,0.3)"),
                padding_y="12px",
            ),
            rx.vstack(
...
def _historial_item_row(item: HistorialItem) -> rx.Component:
    return rx.hstack(
        rx.vstack(
            rx.hstack(
                rx.text(item.nombre, font_size="12px", font_weight="600", color="#E2E8F0"),
                rx.text(
            ...
            rx.cond(
                item.nota != "",
                rx.text("Nota: " + item.nota, font_size="10px", color="rgba(255,255,255,0.35)"),
                rx.fragment(),
            ),
            rx.text(item.enviado_en_texto, font_size="10px", color="rgba(255,255,255,0.25)"),
            spacing="0",
            align="start",
        ),
        rx.spacer(),
...
def _historial_section() -> rx.Component:
    return rx.vstack(
        rx.hstack(
            rx.text("Pedido enviado", font_size="13px", font_weight="700", color="#94A3B8"),
            rx.spacer(),
            rx.text(FoodState.mesa_seleccionada_total_texto, font_size="13px", font_weight="700", color="#F1F5F9"),
            width="100%",
            align="center",
        ),
        rx.cond(
        ...
        rx.cond(
            ...
            rx.center(
                rx.text("Sin items enviados", font_size="12px", color="rgba(255,255,255,0.3)"),
                padding_y="12px",
            ),
            rx.vstack(
    ...
    return rx.box(
        rx.vstack(
            ...
            rx.button(
                ...
                font_size="16px",
                cursor="pointer",
                _hover={"background": "rgba(249,115,22,0.28)"},
            ),
            spacing="2",
            align="start",
        ),
        ...
        border_radius="10px",
        padding="12px",
        _hover={"border": "1px solid rgba(249,115,22,0.30)"},
...
def _menu_section() -> rx.Component:
    return rx.vstack(
        rx.cond(
            ...
            rx.center(
                rx.text("Selecciona una mesa para agregar productos.", font_size="13px", color="rgba(255,255,255,0.35)"),
                padding_y="20px",
            ),
            rx.vstack(
                rx.hstack(
                    rx.button(
                        ...
                        background=rx.cond(FoodState.categoria_activa_id == 0, "rgba(249,115,22,0.22)", "rgba(255,255,255,0.06)"),
                        color=rx.cond(FoodState.categoria_activa_id == 0, "#F97316", "#94A3B8"),
                        border_radius="6px",
                        font_size="12px",
                        cursor="pointer",
                        padding_x="10px",
                    ...
                    rx.foreach(
                        ...
                        lambda cat: rx.button(
                            ...
                            background=rx.cond(FoodState.categoria_activa_id == cat.id, "rgba(249,115,22,0.22)", "rgba(255,255,255,0.06)"),
                            color=rx.cond(FoodState.categoria_activa_id == cat.id, "#F97316", "#94A3B8"),
                            border_radius="6px",
                            font_size="12px",
                            cursor="pointer",
                            padding_x="10px",
                ...
                rx.cond(
                    ...
                    rx.center(
                        rx.text("Sin productos disponibles en esta categoria.", font_size="13px", color="rgba(255,255,255,0.3)"),
                        padding_y="24px",
                    ),
                    rx.grid(
        ...
        rx.hstack(
            ...
            rx.hstack(
                rx.button(
                    ...
                    background=rx.cond(FoodState.mozos_tab_activa == "salon", "rgba(249,115,22,0.22)", "rgba(255,255,255,0.05)"),
                    color=rx.cond(FoodState.mozos_tab_activa == "salon", "#F97316", "#94A3B8"),
                    border_radius="8px",
                    font_size="13px",
                    cursor="pointer",
                    padding_x="14px",
                ...
                rx.button(
                    ...
                    background=rx.cond(FoodState.mozos_tab_activa == "menu", "rgba(249,115,22,0.22)", "rgba(255,255,255,0.05)"),
                    color=rx.cond(FoodState.mozos_tab_activa == "menu", "#F97316", "#94A3B8"),
                    border_radius="8px",
                    font_size="13px",
                    cursor="pointer",
                    padding_x="14px",
                ...
                rx.button(
                    ...
                    background=rx.cond(FoodState.mozos_tab_activa == "historial", "rgba(249,115,22,0.22)", "rgba(255,255,255,0.05)"),
                    color=rx.cond(FoodState.mozos_tab_activa == "historial", "#F97316", "#94A3B8"),
                    border_radius="8px",
                    font_size="13px",
                    cursor="pointer",
                    padding_x="14px",
        ...
        rx.cond(
            ...
            rx.cond(
                ...
                rx.cond(
                    ...
                    rx.vstack(
                        _carrito_section(),
                        rx.divider(border_color="rgba(255,255,255,0.07)"),
                        _historial_section(),
                        spacing="4",
                        width="100%",
                    ),
