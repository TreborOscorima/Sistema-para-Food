...
def _categoria_row(cat: CategoriaView) -> rx.Component:
    return rx.hstack(
        rx.vstack(
            rx.hstack(
                rx.text(cat.emoji + " " + cat.nombre, font_size="14px", font_weight="600", color="#F1F5F9"),
                rx.badge(
                ...
                rx.cond(
                    cat.activa,
                    rx.badge("Activa", background="rgba(34,197,94,0.12)", color="#22C55E", border_radius="5px", font_size="10px"),
        ...
        rx.hstack(
            rx.icon(
                tag="chevron_up", size=14, color="#94A3B8", cursor="pointer",
                on_click=FoodState.mover_categoria(cat.id, "arriba"),
                _hover={"color": "#EA580C"},
            ),
            rx.icon(
                tag="chevron_down", size=14, color="#94A3B8", cursor="pointer",
    ...
    return rx.hstack(
        ...
        rx.vstack(
            rx.hstack(
                ...
                rx.cond(
                    prod.disponible,
                    rx.badge("Disponible", background="rgba(34,197,94,0.12)", color="#22C55E", border_radius="5px", font_size="10px"),
        ...
        rx.button(
            ...
            border=rx.cond(prod.tiene_modificadores, "1px solid rgba(124,58,237,0.30)", "1px solid #334155"),
            border_radius="6px",
            font_size="11px",
            cursor="pointer",
            padding_x="8px",
    ...
    return rx.dialog.root(
        rx.dialog.content(
            rx.vstack(
                ...
                rx.box(height="1px", width="100%", background="#1E293B"),
                rx.input(
                    placeholder="Nombre *",
                ...
                rx.hstack(
                    rx.text("Orden:", font_size="13px", color="#94A3B8", white_space="nowrap"),
                    rx.input(
                ...
                rx.hstack(
                    rx.text("Estación:", font_size="13px", color="#94A3B8", white_space="nowrap"),
                    rx.select(
                        ["cocina", "barra"],
    ...
    return rx.dialog.root(
        rx.dialog.content(
            rx.vstack(
                ...
                rx.vstack(
                    rx.hstack(
                        rx.text("Ícono", font_size="12px", font_weight="600", color="#94A3B8"),
                    ...
                    rx.hstack(
                        ...
                        rx.input(
                            ...
                            color="#F1F5F9", border_radius="8px",
                    ...
                    rx.flex(
                        *[
                            rx.box(
                                ...
                                border_radius="6px", border="1px solid #334155",
                                background="#1E293B",
                ...
                # ── Etiquetas ────────────────────────────────────────────────
                rx.vstack(
                    rx.text("Etiquetas", font_size="12px", font_weight="600", color="#94A3B8"),
                    rx.hstack(
                        *[
                            rx.box(
                                f"{emoji} {label}",
                                ...
                                border=rx.cond(
                                    FoodState.producto_form_tags.contains(tag),
                                    "1.5px solid #EA580C", "1px solid #334155",
                                ),
                ...
                # ── Imagen ───────────────────────────────────────────────────
                rx.vstack(
                    rx.text("Imagen del plato", font_size="12px", font_weight="600", color="#94A3B8"),
                    rx.cond(
                        ...
                        rx.hstack(
                            ...
                            rx.vstack(
                                rx.text("Imagen cargada", font_size="11px", color="#22C55E", font_weight="600"),
                                rx.button(
                                    "Quitar imagen",
                        ...
                        rx.upload(
                            rx.vstack(
                                ...
                                rx.text("Arrastre o haga clic", font_size="11px", color="#94A3B8"),
...
def _grupo_mod_row(grupo: GrupoModificadorAdminView) -> rx.Component:
    return rx.hstack(
        rx.vstack(
            rx.text(grupo.nombre, font_size="13px", font_weight="600", color="#F1F5F9"),
            rx.hstack(
                rx.text(
        ...
        border_radius="8px", border="1px solid #334155",
        gap="8px",
    )
    ...
    return rx.dialog.root(
        rx.dialog.content(
            rx.vstack(
                ...
                rx.hstack(
                    rx.vstack(
                        rx.text("Mín selecciones", font_size="11px", color="#94A3B8"),
                        rx.input(
                    ...
                    rx.vstack(
                        rx.text("Máx selecciones", font_size="11px", color="#94A3B8"),
                        rx.input(
                    ...
                    rx.vstack(
                        rx.foreach(
                            ...
                            lambda g: rx.hstack(
                                ...
                                rx.text(g.nombre, font_size="13px", color="#F1F5F9", font_weight="500"),
                                rx.text(
...
def _combo_row(combo: dict) -> rx.Component:
    return rx.hstack(
        ...
        rx.vstack(
            rx.text(combo["nombre"].to(str), font_size="13px", font_weight="600", color="#F1F5F9"),
        ...
        rx.hstack(
            rx.icon_button(
                ...
                background="transparent", color="#94A3B8", border="none", size="1",
                ...
                rx.vstack(
                    rx.hstack(
                        ...
                        rx.button(
                            ...
                            background="#1E293B", color="#94A3B8",
                            border="1px solid #334155", border_radius="5px",
...
def _combos_section() -> rx.Component:
    return rx.vstack(
        rx.hstack(
            rx.text("Combos", font_size="15px", font_weight="700", color="#94A3B8"),
            rx.badge(
...
def _modificadores_section() -> rx.Component:
    return rx.vstack(
        rx.hstack(
            rx.text("Modificadores", font_size="15px", font_weight="700", color="#94A3B8"),
            rx.badge(
    ...
    return rx.vstack(
        ...
        rx.hstack(
            rx.vstack(
                ...
                rx.text("Categorías y productos de la carta", font_size="13px", color="#94A3B8"),
                spacing="0",
            ),
            rx.spacer(),
            rx.hstack(
        ...
        rx.flex(
            ...
            rx.vstack(
                rx.hstack(
                    rx.text("Categorías", font_size="15px", font_weight="700", color="#94A3B8"),
                    rx.badge(
