...
# tuwayki-core (público en GitHub) se instala vía requirements.txt, pinneado por
# SHA. Fuente de verdad única: la línea `tuwayki-core @ git+...@<SHA>` en
# requirements.txt (bumpear ahí). Sin _vendor ni línea de install separada.
